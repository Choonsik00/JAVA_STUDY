...
public class 수업 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 제네릭과 걸렉션즈란? 배열처럼 데이터를 저장함 빠른 접근 속도와 '동적 크기' 조절이 가능한 장점들이 있습니다.
		 */
		 ...
		 */
		list.add(10); // 0번째 10추가
		list.add(5); // 1번째 5추가
		list.add(34); // 2번째 34추가
		...
		System.out.println("0번째 요소 조회: " + list.get(0)); // 10은 삭제 5가 출력
		System.out.println("사이즈 조회: " + list.size());

		// 수정
		list.set(0, 100); // 0번째 요소에 100으로 수정
		System.out.println("0번째 요소 조회: " + list.get(0)); // 100 출력
		...
		/*
		 * HashSet 컬렉션즈 HashSet: 중복 제거가 필요하거나 집합 연산을 수행해야 할 때 유용하게 사용됨 1. 중복을 허용하지 않는
		 * 고유한 요소만 저장
		 */
